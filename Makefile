...
SOURCE_FILES = $(wildcard source/*.cpp) \
	      ...
	      $(wildcard source/engine/vectorclass/special/*.cpp) \
...
CXXFLAGS=-Isource -Isource/communicator -Isource/global -Isource/history -Isource/random -Isource/engine -Isource/engine/qeval -Isource/engine/vectorclass -Isource/engine/vectorclass/special -std=c++11 -mavx2 -mbmi -O3 -flto -mfma  
