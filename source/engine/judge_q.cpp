...
int JudgeQ :: verdict(const Community& com, const PlayerCards& p1, const PlayerCards& p2) const {
...
void JudgeQ :: addScenario(const Community& com, const PlayerCards& p1, const PlayerCards& p2) {
