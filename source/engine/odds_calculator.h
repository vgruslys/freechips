...
class OddsCalculator
{
    public:
        ...
        virtual std::pair<float, float>  handOdds(Card, Card, Card, Card, Card*, int) = 0; //Compute hand odds, knowing the oppnent's cards
        virtual std::pair<float, float> handOdds(Card, Card, Card*, int) = 0; //Compute hand odds, not knowing the opponnent's cards
};
#endif